...
def arm2fit_turn_corner_forward():
    ...
    time.sleep(0.05)
# xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
def distance_case(distance, valueDegX, valueDegY, Servo0, Servo1, Servo2, Servo3, Servo4, loop_degServo1, loop_degServo2, loop_degServo3):
	...
	for i in range(0, 11, 1):
		...
		" ~ " + str(int(math.ceil(degServo2))) +
		" | servo 3: "+ str(degServo3) +
		" ~ " + str(int(math.ceil(degServo3)) ))


    '''
    def distance_case_channel2(): #servo channel 2
	if(int(valueDegY) < 151):
	    for start_servo2 in range(30, int(degServo2) +1, start_servo2 =  start_servo2 + loop_degServo2):
		S2 = math.ceil(degServo2 + loop_degServo2)
		#calDeg(2, 2, i)
		print("\ni: "+str(start_servo1))
		print("servo 2 deg: "+str(S2))
		time.sleep(0.025)
...
def turn_back():
    ...
    time.sleep(0.05)
# xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
def showMsg(distance, valueDegX, valueDegY, Servo0, Servo1, Servo2, Servo3, Servo4, loop_degServo1, loop_degServo2, loop_degServo3):
    print("\nFunction: showMsg")
    print("======================")
...
#global Servo0, Servo1, Servo2, Servo3, Servo4
#global loop_degServo1, loop_degServo2, loop_degServo3
...
if average_Camera > 0 and average_Camera <= 30:
    ...
    showMsg(distance, valueDegX, valueDegY, Servo0, Servo1, Servo2, Servo3, Servo4, loop_degServo1, loop_degServo2, loop_degServo3)
    distance_case(distance, valueDegX, valueDegY, Servo0, Servo1, Servo2, Servo3, Servo4, loop_degServo1, loop_degServo2, loop_degServo3) 
    ...
    showMsg(distance, valueDegX, valueDegY, degServo0, degServo1, degServo2, degServo3, degServo4)
